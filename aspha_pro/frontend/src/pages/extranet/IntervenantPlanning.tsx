...
/**
 * Planning extranet intervenant — clone read-only de PlanningPage avec :
 *  - calendrier identique (eventContent riche, tooltip hover)
 *  - panneau droit ContractSummaryPanel (taux de remplissage contrat)
 *  - panneau droit TripSummaryPanel (trajets payés / non payés + détail jour)
  ...
  return (
    <div>
      ...
      <div className="space-y-5">
        {/* Calendrier sur toute la largeur — l'intervenant n'a qu'un seul
            point de vue donc on profite de tout l'espace pour la grille horaire. */}
        <div className="rounded-2xl bg-card shadow-soft p-4 lg:p-5">
          <FullCalendar
        ...
        {/* Panneaux contrat + trajets en dessous du calendrier, sur 2 colonnes
            en desktop pour aérer. Filtrés automatiquement sur l'intervenant
            connecté — on attend le profile pour éviter de leaker les données
            des autres intervenants pendant le 1er render. */}
        {employeeId && (
