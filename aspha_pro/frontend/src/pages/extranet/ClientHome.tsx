...
import {
  Receipt, FileText, Briefcase, Download, Ticket as TicketIcon, Plus,
...
import {
  useClientInvoices, useClientPrestations, useClientProfile, useClientQuotes,
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground">
            Retrouvez vos documents, prestations et demandes en cours.
          </p>
        </div>
...
// ============================================================
// Dialog : créer une demande depuis l'extranet client
// ============================================================
