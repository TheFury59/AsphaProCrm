...
class SettingsController extends Controller
{
    ...
    /**
     * Endpoint public (auth standard) : retourne uniquement les settings utiles au front
     * (non sensibles), pour configurer l'UI.
     */
    public function publicSettings(Request $request)
    {
        return ['data' => [
            ...
            'silae_portal_url' => AppSetting::get('silae_portal_url'),
